...
```
$ docker image tag gateway itrex/gateway
$ docker push itrex/gateway
$ docker image tag courseservice itrex/courseservice
$ docker push itrex/courseservice
$ docker image tag mediaservice itrex/mediaservice
$ docker push itrex/mediaservice
```
